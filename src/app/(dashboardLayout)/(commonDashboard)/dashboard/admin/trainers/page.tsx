...
import { Trainer, GetTrainersParams, Specialization } from "@/types/trainer.types";
    ...
    return (
        <div className="space-y-6 p-6 bg-gray-50 min-h-screen">
            ...
            <PageHeader
                ...
                action={
                    <Link className="cursor-pointer" href="/admin/trainers/create">
                        <Button>
                                ...
                                trainers.map((trainer) => {
                                    return (
                                        <tr key={trainer.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4">
                                                <div>{trainer.experienceYears} years</div>
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                <div className="text-xs text-gray-500">
                                                    {Math.round((trainer.currentClients / trainer.maxCapacity) * 100)}% capacity
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex flex-col gap-1">
                                                    <Badge
                                                        variant={trainer.user.isActive ? "default" : "secondary"}
                                                        className="w-fit"
                                                    >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => handleDelete(trainer.id, trainer.user.name)}
