...
const mockExistingPlan = {
    ...
    description:
        "A comprehensive 12-week program designed to build maximum strength and muscle mass.",
    category: "strength",
    difficulty: "advanced",
    duration: "12",
    workoutDays: [
...
export default function EditWorkoutPlanPage() {
    ...
    useEffect(() => {
        ...
        setPlanName(mockExistingPlan.name);
        setDescription(mockExistingPlan.description);
        setCategory(mockExistingPlan.category);
        setDifficulty(mockExistingPlan.difficulty);
        setDuration(mockExistingPlan.duration);
        setWorkoutDays(mockExistingPlan.workoutDays);
        setSelectedClients(mockExistingPlan.assignedClients);
    }, []);
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <PageHeader
                    ...
                    description="Update your workout plan details"
                />
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update the basic details of your workout plan
                            </CardDescription>
                        </CardHeader>
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>
                                        Update exercises for each training day
                                    </CardDescription>
                                </div>
